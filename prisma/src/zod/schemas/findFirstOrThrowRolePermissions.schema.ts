...
export const RolePermissionsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RolePermissionsSelect> = z.object({
...
export const RolePermissionsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    module: z.boolean().optional(),
    userAccess: z.boolean().optional(),
    advancedAccess: z.boolean().optional(),
